...
const Drawer = ({ drawerIsOpen }: DrawerTypes) => {
	...
	return (
		<TWDrawer>
			...
			<Link
				to="/storage"
				className={`${location.pathname === '/storage' ? 'hidden' : 'block'}`}
			>
				<TWButtonSpan>
					<svg
						xmlns="http://www.w3.org/2000/svg"
			...
			<Link
				to="/shopping"
				className={`${location.pathname === '/shopping' ? 'hidden' : 'block'}`}
			>
				<TWButtonSpan>
					<svg
						xmlns="http://www.w3.org/2000/svg"
					...
					<p className='text-secondary'>Shopping</p>
				</TWButtonSpan>
			</Link>

			<Link
				to="/recipe"
				className={`${location.pathname === '/recipe' ? 'hidden' : 'block'}`}
			>
				<TWButtonSpan>
					<svg
						xmlns="http://www.w3.org/2000/svg"
					...
					<p className='text-secondary'>Recipes</p>
				</TWButtonSpan>
			</Link>
		</TWDrawer>
	);
